...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2024 at 02:55 PM
...
(14, 'Quạt trần 3 cánh điện cơ 25cm', 'Quạt trần điện cơ thống nhất Vinawind QT1400-S, cánh sắt 1,4m    \r\nQuạt trần điện cơ thống nhất Vinawind QT1400-S sở hữu kiểu dáng sang trọng, màu xanh ngọc, hơn nữa cánh quạt chắc chắn, động cơ hoạt động mạnh mẽ, mang lại luồng gió mát dịu một cách nhanh chóng. ', 890000.00, '31873_3795_quat-tran-panasonic-f-60mz2.jpg', 'Vinawind - Ðiện cơ', 'Quạt trần', '75', '5', 'Công suất: 75 W, Đường kính cánh: 1,4m\r\nTy quạt: 25cm\r\nLưu lượng gió: 256 m³/phút\r\nĐiều khiển hộp số cơ 5 tốc độ', 'Việt Nam'),
...
(18, 'Quạt lửng Coex', 'Quạt Coex có thiết kế nhỏ gọn tiết kiệm diện tích. Lồng quạt chắc chắn, đan khít an toàn, dễ dàng vệ sinh. Động cơ đồng, hoạt động êm và bền bỉ. Trục quay bằng vòng bi vận hành êm ái độ bền cao. \r\n\r\n', 1390000.00, 'quat-tich-dien-coex---cf-7114r_eb554245.png', 'Coex', 'Quạt lửng', '24', '3', 'Quay đảo chiều, gió tản đều\r\nThời gian sạc đầy 12 - 15 giờ\r\nDung lượng pin lớn, hoạt động liên tục trong 5 - 16 giờ tùy tốc độ', 'Trung Quốc');
